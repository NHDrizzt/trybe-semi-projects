// Ponto 1
const changeSecondParagraph = () =>
  (document.querySelectorAll(".center-content > p")[1].innerText = "Voando");
...
// Ponto 3
const changeCenterContentColor = () =>
...
const paragraphContentInsideFooter = () => {
  const allParagraphsCenterContent =
