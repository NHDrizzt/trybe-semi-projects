...
- Use o comando: `git clone git@github.com:tryber/sd-030-a-exercise-functions-in-practice`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-030-a-exercise-functions-in-practice`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-030-a-exercise-functions-in-practice/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-030-a-exercise-functions-in-practice/pulls) e confira que o seu _Pull Request_ está criado
